...
const AllDoctors = () => {
	...
	console.log(search, gender, speciality);

	return (
		<div className="text-center space-y-4 my-10">
			<h4 className="font-semibold text-3xl">Healthcare Excellence</h4>
			<h1 className="text-5xl font-bold">
				Your Healing <span className="text-cyan-600">Destination</span>
			</h1>
			<p className="w-full md:w-1/2 mx-auto">
				In our mission to provide top-notch healthcare, we proudly present our
				comprehensive service section. At our clinic, we understand the
				importance of a holistic approach to healthcare.
			</p>
			<div className="mx-2 md:mx-12 font-serif mt-10">
				...
				{loading ? (
					...
					allDoctors.map((doc) => (
						<div
							key={doc._id}
							className="flex items-center flex-wrap justify-between hover:shadow-2xl shadow-slate-800 mb-5 border rounded-xl"
						>
							<div className="w-full lg:w-[37%] space-x-2 space-y-3">
								<div className="flex flex-wrap items-center">
									...
									<div className="text-left border-l-4 md:border-l-0 border-cyan-600 pl-3 mt-4 md:mt-0">
										...
										<p className="text-sm text-slate-500">{doc.education}</p>
									</div>
								</div>
							...
							<div className="w-full lg:w-[33%] border-x-4 border-cyan-600 pl-4 flex flex-col justify-end space-y-1 py-3">
								...
								<div className="flex items-center">
									...
									<button className="border-2 hover:border-red-600 duration-300 hover:text-red-600 relative inline-flex items-center justify-center px-1 rounded-md mb-2 mr-2 text-sm font-medium">
										<svg
