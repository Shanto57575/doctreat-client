...
const Stat = () => {
	return (
		<div className="text-center">
			<div className="stats lg:rounded-tr-full lg:rounded-es-full w-full lg:w-[1000px] stats-vertical lg:stats-horizontal shadow bg-gradient-to-r from-slate-900 via-gray-500 to-slate-400 hover:bg-gradient-to-br rounded-none my-5">
				<div className="stat">
				...
				<div className="stat">
					<div className="stat-value text-purple-100">
						<CountUp start={1} end={99} duration={5} />%
					</div>
					<div className="stat-title text-purple-100">Patient</div>
					<div className="stat-desc text-purple-100">Satisfaction Rate</div>
				</div>
			</div>
		</div>
	);
